    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            case MAIN_MENU:
                ...
                g2d.drawString("Use w a d keys to control the rocket.", frameWidth / 2 - 117, frameHeight / 2); g2d.setColor(Color.BLACK);
                g2d.drawString("Update By BH, YB", frameWidth / 2 - 59, frameHeight / 2+200);
                g2d.setColor(Color.BLUE);
